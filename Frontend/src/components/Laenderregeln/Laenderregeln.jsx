            ...
            <div className="land">
                ...
                <div className="caption">
                    ...
                    <p>Campen <br />
                        ...
                        <br />
                        Wildcampen <br />
                        ist in deutschland verboten, wird mit einer strafe ab 100 euro berechnet
                        Campen auf offiziellen campingstellen <br />
                        <br />
                        Freistehen <br />
                        Es ist erlaubt auf öffentlichen KFZ-Parkplätzen zu stehen um die Fahrtüchtigkeit wieder zu gewährleiten zu können. </p>
                </div>
            </div>
            <div className="land">
                <img src={Daenemark} />
                <div className="caption">
                    ...
                    <p>Campen <br />
                        ...
                        <br />
                        Freistehen <br />
                        Freistehen ist nur zur Fahrzeug wiederherstellung erlaubt </p>
                </div>
            </div>
            <div className="land">
                <img src={Tschechien} />
            ...
            <div className="land">
                ...
                <div className="caption">
                    ...
                    <p>Campen <br />
                        ...
                        <br />
                        Wildcampen <br />
                        Wildcampen ist offiziell nicht erlaubt. Strafen können bis zu 120€ ausfallen  <br />
                        <br />
                        Freistehen <br />
                        Freistehen ist grundsätzlich erlaubt solange die regeln eingehalten werden
                    </p>
                </div>
            </div>
            <div className="land">
                ...
                <div className="caption">
                    ...
                    <p>Campen <br />
                        ...
                        <br />
                        Freistehen <br />
                        Freistehen ist generell nicht erlaubt.
                        Strafen werden mit bis zu 500€ geahndet.
                    </p>
                </div>
            </div>
            <div className="land">
                ...
                <div className="caption">
                    ...
                    <p>Campen <br />
                        ...
                        <br />
                        Freistehen <br />
                        freistehen ist für 1-3 Nächte ausserhalb des Naturschutzgebietes erlaubt
            ...
            <div className="land">
                ...
                <div className="caption">
                    ...
                    <p>Campen <br />
                        ...
                        <br />
                        Wildcampen <br />
                        Wildcampen ist nicht erlaubt. Es können Strafen bis zu 150€ ausfallen. <br />
                        allerdings gibt es "Pfahl Campingplätze" auf denen es erlaubt ist.<br />
                        <br />
                        Freistehen <br />
            ...
            <div className="land">
                ...
                <div className="caption">
                    ...
                    <p>Campen <br />
                        ...
                        Privatgrundstücken ist es nicht erlaubt.<br />
                        <br />
                        Freistehen <br />
            ...
            <div className="land">
                ...
                <div className="caption">
                    ...
                    <p>Campen <br />
                        ...
                        Genehmigung des Besitzers auch auf deren Grundstück.<br />
                        <br />
                        Freistehen <br />
                        Eine Nacht im Fahrzeug zur Wiederherstellung des Fahrzeugs ist gestattet.
                    </p>
                </div>
            </div>
